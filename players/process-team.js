...
function assignSequentialValues(team1Data, team2Data) {
  let team1players = team1Data.filter((player) => player.player.id);
  let team2players = team2Data.filter((player) => player.player.id);
  ...
  players.forEach((player, index) => {
    playerIdMap[player.player.id] = index;
  });
...
const team1 = "Inter Miami";
const team2 = "Real Salt Lake";
